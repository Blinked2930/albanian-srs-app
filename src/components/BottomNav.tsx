...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto bg-white/60 backdrop-blur-xl rounded-[2rem] p-1.5 flex justify-between items-center shadow-[0_8px_32px_rgba(0,0,0,0.05)] pointer-events-auto border-2 border-white mx-4">
        
        <Link 
          href="/" 
          className={`flex flex-col items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-[1.5rem] transition-all duration-300 active:scale-90 ${pathname === '/' ? 'bg-pink-100/80 text-pink-500 shadow-sm' : 'text-slate-400 hover:text-pink-400'}`}
        >
        ...
        <Link 
          href="/drill/word" 
          className={`flex flex-col items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-[1.5rem] transition-all duration-300 active:scale-90 ${pathname.startsWith('/drill/word') ? 'bg-indigo-100/80 text-indigo-500 shadow-sm' : 'text-slate-400 hover:text-indigo-400'}`}
        >
        ...
        <Link 
          href="/drill/sentence" 
          className={`flex flex-col items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-[1.5rem] transition-all duration-300 active:scale-90 ${pathname.startsWith('/drill/sentence') ? 'bg-emerald-100/80 text-emerald-500 shadow-sm' : 'text-slate-400 hover:text-emerald-400'}`}
        >
        ...
        <Link 
          href="/immersion" 
          className={`flex flex-col items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-[1.5rem] transition-all duration-300 active:scale-90 ${pathname.startsWith('/immersion') ? 'bg-fuchsia-100/80 text-fuchsia-500 shadow-sm' : 'text-slate-400 hover:text-fuchsia-400'}`}
        >
        ...
        <Link 
          href="/manage" 
          className={`flex flex-col items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-[1.5rem] transition-all duration-300 active:scale-90 ${pathname === '/manage' ? 'bg-rose-100/80 text-rose-500 shadow-sm' : 'text-slate-400 hover:text-rose-400'}`}
        >
